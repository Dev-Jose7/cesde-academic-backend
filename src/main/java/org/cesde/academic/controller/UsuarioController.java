...
public class UsuarioController {
    ...
    @PostMapping("/crear")
    @PreAuthorize("hasRole('ROLE_ADMIN') or hasRole('ROLE_DEV') and hasAuthority('CREATE')")
    ...
    @GetMapping("/lista")
    @PreAuthorize("hasRole('ROLE_ADMIN') or hasRole('ROLE_DEV') and hasAuthority('READ')")
    ...
    @PreAuthorize("hasRole('ROLE_ADMIN') or hasRole('ROLE_DEV') and hasAuthority('UPDATE')")
